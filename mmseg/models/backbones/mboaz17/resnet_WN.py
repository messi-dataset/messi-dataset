...
from ...utils.mboaz17.res_layer_WN import ResLayerWeightNorm
...
class Bottleneck(BaseModule):
    ...
    def __init__(self,
        ...
        self.conv3 = build_conv_layer(
            ...
            kernel_size=1,
            bias=False)
        self.conv3 = nn.utils.weight_norm(self.conv3, dim=None)
...
class ResNetWeightNorm(BaseModule):
    """ResNet backbone.
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ResNetWeightNorm, self).__init__(init_cfg)
    ...
    def make_res_layer(self, **kwargs):
        ...
        return ResLayerWeightNorm(**kwargs)
    ...
    def _make_stem_layer(self, in_channels, stem_channels):
        ...
        if self.deep_stem:
            self.stem = nn.Sequential(
                nn.utils.weight_norm(build_conv_layer(
                    self.conv_cfg,
                    in_channels,
                    stem_channels // 2,
                    kernel_size=3,
            ...
            self.conv1 = nn.utils.weight_norm(build_conv_layer(
                self.conv_cfg,
                in_channels,
                stem_channels,
                kernel_size=7,
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNetWeightNorm, self).train(mode)
        self._freeze_stages()
...
@BACKBONES.register_module()
class ResNetV1cWeightNorm(ResNetWeightNorm):
    ...
    def __init__(self, **kwargs):
        super(ResNetV1cWeightNorm, self).__init__(
            deep_stem=True, avg_down=False, **kwargs)


@BACKBONES.register_module()
class ResNetV1dWeightNorm(ResNetWeightNorm):
    ...
    def __init__(self, **kwargs):
        super(ResNetV1dWeightNorm, self).__init__(
