...
from ...utils.mboaz17.res_layer_normless import ResLayerNormLess
...
class ResNetNormLess(BaseModule):
    """ResNet backbone.
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ResNetNormLess, self).__init__(init_cfg)
    ...
    def make_res_layer(self, **kwargs):
        ...
        return ResLayerNormLess(**kwargs)
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNetNormLess, self).train(mode)
        self._freeze_stages()
...
@BACKBONES.register_module()
class ResNetV1cNormLess(ResNetNormLess):
    ...
    def __init__(self, **kwargs):
        super(ResNetV1cNormLess, self).__init__(
            deep_stem=True, avg_down=False, **kwargs)


@BACKBONES.register_module()
class ResNetV1dNormLess(ResNetNormLess):
    ...
    def __init__(self, **kwargs):
        super(ResNetV1dNormLess, self).__init__(
